...
public class EngPageRefCompService {
    ...
    public int updateBatch(List<EngPageRefComp> list) {
        return engPageRefCompMapper.updateBatch(list);
    }

    public int batchInsert(List<EngPageRefComp> list) {
        return engPageRefCompMapper.batchInsert(list);
    }
}
